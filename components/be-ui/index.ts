export { default as BeEllipsis } from './package/ellipsis' // 全局、按需
export { default as BeTag } from './package/tag' // 全局、按需
export { default as BeTooltip } from './package/tooltip' // 全局、按需
export { default as BeButton } from './package/button' // 全局、按需
export { default as BeIcon } from './package/svg-icon' // 全局、按需
