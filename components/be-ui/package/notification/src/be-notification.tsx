...
export default defineComponent({
  ...
  setup(props) {
     ...
     */
    const setAnimate = () => {
      const classStr = `be-${props.compType} be-${props.compType}__${
        option.value.msgType
      } be-${props.compType}__${option.value.placement} 
    ...
    const renderBody = function (h: any) {
      ...
      return h(
        <div
          className={`be-${props.compType}--container be-${props.compType}--container__${option.value.placement}`}
        >
          <div className={`be-${props.compType}--title`}>
            <div
              className={`be-${props.compType}--head`}
            ...
            >
              <div>
                ...
                <span className={`txt__${option.value.msgType}`}>
                  {option.value.titles}
                </span>
              </div>
              {/** @slot 弹窗头部按钮**/}
          ...
          {props.compType === "notification" ? (
            <div className={`be-${props.compType}--body`}>
              {option.value.bodyRender ? (
                option.value.bodyRender()
              ) : (
                <p className={`be-${props.compType}--description`}>
    ...
    return () => {
      ...
      return (
        <div
          ...
          className={containerClass.value}
