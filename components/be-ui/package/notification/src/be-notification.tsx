      ...
      return h(
        <div
          ...
          <div className={`be-${props.compType}--title`}>
            <div className={`be-${props.compType}--head`} id={`be_${props.compType}_head${uid}`}>
              <div>
                {isLoading.value
                  ? (
                  <BeIcon
                ...
                <span className={`txt__${option.value.msgType}`}>{option.value.titles}</span>
              </div>
              {/** @slot 弹窗头部按钮**/}
          ...
          {props.compType === 'notification'
            ...
            <div className={`be-${props.compType}--body`}>
              {option.value.bodyRender
                ...
                : (
                <p className={`be-${props.compType}--description`}>{option.value.description}</p>
                  )}
            </div>
              )
            : (
